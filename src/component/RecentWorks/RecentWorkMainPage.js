                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-x-6 gap-y-28 lg:gap-y-16">
                        ...
                        <div class="relative group h-52 flex   flex-col rounded-xl bg-[#F97316] bg-clip-border text-gray-700 shadow-md mt-16">
                            <Link to="https://khabo-ki.netlify.app" class="block">
                                <div class="h-50">
                                    <div
                                        class="absolute -top-5 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-50%]  group-hover:opacity-[0.9]   duration-300 w-[90%] h-52 bg-gray-700 rounded-xl justify-items-center align-middle">
                                        <img src={khaboki}
                                            class="w-72 h-44  mt-4 m-auto" alt="Automotive" title="Automotive" loading="lazy"
                                            width="200" height="200" />
                                    </div>
                                </div>
                                <div class="p-6 mt-20  z-40 w-full   ">
                                    <Link to='https://khabo-ki.netlify.app/'
                                    ...
                                    <Link to='https://github.com/zamanmonirbu/khabo-ki'
                                        class=" inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Frontend code
                                    </Link>
                                    <Link to='https://github.com/zamanmonirbu/khabo-ki-backend'
                        ...
                        <div class="relative group h-52 flex   flex-col rounded-xl bg-[#B3E0D2] bg-clip-border text-gray-700 shadow-md mt-28">
                            <Link to="https://rescuehospital.netlify.app/" class="block">
                                <div class="h-50">
                                    <div
                                        class="absolute -top-5 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-55%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-52 bg-[#104374] rounded-xl justify-items-center align-middle">
                                        <img src={rescue}
                                            class="w-72 h-44  mt-4 m-auto" alt="Automotive" title="Automotive" loading="lazy"
                                            width="200" height="200" />
                                    </div>
                                ...
                                <div class="p-6 mt-20  z-40 w-full   ">
                                    <Link to='https://rescuehospital.netlify.app/'
                                        class="  inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Live site
                                    </Link>
                                    <Link to='https://github.com/zamanmonirbu/hospital-client'
                                        class=" inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Frontend code
                                    </Link>
                                    <Link to='https://github.com/zamanmonirbu/hospital-backend'
                                        class="mb-2 inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Backend code
                                    </Link>
                                </div>
                        ...
                        <div class="relative group h-52 flex   flex-col rounded-xl bg-[#0A0A0A] bg-clip-border text-gray-700 shadow-md mt-40">
                            <Link to="https://ridesharebd.netlify.app/" class="block">
                                <div class="h-50">
                                    <div
                                        class="absolute -top-5 lg:top-[-10%] left-[5%] z-40  group-hover:top-[-55%] group-hover:opacity-[0.9]   duration-300 w-[90%] h-52 bg-[#FF9C00] rounded-xl justify-items-center align-middle">
                                        <img src={niyejao}
                                            class="w-72 h-44  mt-4 m-auto" alt="Automotive" title="Automotive" loading="lazy"
                                            width="200" height="200" />
                                    </div>
                                ...
                                <div class="p-6 mt-20  z-40 w-full   ">
                                    <Link to='https://ridesharebd.netlify.app/'
                                        class="  inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Live site
                                    </Link>
                                    <Link to='https://github.com/zamanmonirbu/ride-share-with-authentication'
                                        class=" inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Frontend code
                                    </Link>
                                    <Link to='https://github.com/zamanmonirbu/rideshare-backend'
                                        class="mb-2 inline-block text-tg text-center w-full  text-xl  font-sans  font-semibold leading-snug tracking-normal   antialiased hover:text-red-500">
                                        Backend code
                                    </Link>
                                </div>
