...
const NewsletterCard = () => {
  ...
  return (
    <div className="max-w-md mx-auto p-6 text-white bg-gray-500 rounded-2xl mt-8 shadow-2xl text-left pt-10">
      ...
      {!subscribed ? (
        <div className="flex items-center">
          <input
            ...
            className="flex-1 py-2 px-4 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500 text-black"
            value={email}
