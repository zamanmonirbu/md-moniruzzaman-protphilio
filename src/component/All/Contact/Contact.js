...
const ContactComponent = () => {
  ...
  const handleSentClick = () => {
    // Handle sending the data or any other action
  ...
  return (
   <div >
    ...
    <div className="text-left p-10 flex bg-[#354261] text-white w-[90%] items-center justify-center ml-8 md:ml-16 rounded-2xl shadow-lg -mt-12" >
      <div className="w-1/2 mr-8 ">
        <h1 className='text-4xl font-bold'>
        Lets talk about everything!
        </h1>
        <p className='text-xl py-8'>Hate forms? Send me an <Link className='text-blue'>Email</Link> instead.</p>
        <img className="w-32 h-32 ml-20" src={contact} alt="Some" />
      </div>
      <div className='w-1/2 '>
