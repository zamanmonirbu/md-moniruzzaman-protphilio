    ...
    <div className="fixed inset-0 flex items-center justify-end bg-gray-500 bg-opacity-50 z-50 ">
      <div className="bg-white p-8 rounded-lg md:w-[35%] relative overflow-hidden h-full">
        ...
        <div className="text-left pt-10">
          <p className="text-md mt-2 bg-gray-200 p-4 rounded-xl">Hi! This is kalu miah. I'm excited to talk with you. However, I'm just in the alpha stage now. Zaman will upgrade me soon. I'll be more intelligent then 😊</p>
        </div>
        {/* <div className="flex-grow"></div> Empty div to push the following section to the bottom */}
        <div className="absolute top-[95%] left-1/3 transform -translate-x-1/2 -translate-y-1/2 text-white px-4 py-2 rounded ml-4">
          ...
          <div class="max-w-4xl mx-auto">
            ...
            <form>
              ...
              <input type="text"  className='dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded-md' placeholder="Your message..." />
