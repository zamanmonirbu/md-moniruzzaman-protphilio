    ...
    <footer className="bg-white dark:bg-gray-900">
      <div className="container px-4 py-6 mx-auto">
       ...
       <Link to='/'><img src={myLogo} alt="my Logo" className="h-12 w-12 mr-2 rounded-full ml-11 ring-2" /></Link>
        <Link to='/'> <h1 className="text-xl font-bold text-black text-left p-2">MONIRUZZAMAN</h1></Link>
       </div>
          ...
          <div className="flex -mx-2">
            <Link to="#" className="mx-2 text-gray-600 transition-colors duration-300 dark:text-gray-300 hover:text-blue-500 dark:hover:text-blue-400" aria-label="Reddit">
              <svg className="w-10 h-9 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
